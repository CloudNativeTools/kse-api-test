...
class V1beta1ResourceAttributes:
    ...
    resourceScope: Optional[str] = field(default=None)
...
class V1beta1SubjectAccessReviewSpec:
    ...
    nonResourceAttributes: Optional[V1beta1NonResourceAttributes] = field(default=None)
    resourceAttributes: Optional[V1beta1ResourceAttributes] = field(default=None)
...
class V1beta1SubjectAccessReviewStatus:
    ...
    evaluationError: Optional[str] = field(default=None)
