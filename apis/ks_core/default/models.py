...
@define(kw_only=True)
class V1alpha2Scope:
    namespaceSelector: Optional[str] = field(default=None)
    namespaces: Optional[List[str]] = field(default=None)


@define(kw_only=True)
class V1alpha2IngressClassScopeSpec:
    ingressClass: Optional[V1alpha2IngressClass] = field(default=None)
    scope: Optional[V1alpha2Scope] = field(default=None)


@define(kw_only=True)
class V1alpha2IngressClassScope:
    apiVersion: Optional[str] = field(
        default=None,
        metadata={
            "description": "APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources"
