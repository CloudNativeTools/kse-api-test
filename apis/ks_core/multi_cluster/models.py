...
@define(kw_only=True)
class V1alpha1Connection:
    externalKubernetesAPIEndpoint: Optional[str] = field(default=None)
    kubeconfig: Optional[str] = field(default=None)
    kubernetesAPIEndpoint: Optional[str] = field(default=None)
    kubernetesAPIServerPort: Optional[int] = field(default=None)
    kubesphereAPIEndpoint: Optional[str] = field(default=None)
    kubesphereAPIServerPort: Optional[int] = field(default=None)
    token: Optional[str] = field(default=None)
    type: Optional[str] = field(default=None)


@define(kw_only=True)
class V1alpha1ClusterSpec:
    config: Optional[str] = field(default=None)
    connection: Optional[V1alpha1Connection] = field(default=None)
    enable: Optional[bool] = field(default=None)
    externalKubeAPIEnabled: Optional[bool] = field(default=None)
    joinFederation: Optional[bool] = field(default=None)
...
@define(kw_only=True)
class V1alpha1ClusterStatus:
    conditions: Optional[List[V1alpha1ClusterCondition]] = field(default=None)
    configz: Optional[Dict] = field(default=None)
    kubeSphereVersion: Optional[str] = field(default=None)
    kubernetesVersion: Optional[str] = field(default=None)
    nodeCount: Optional[int] = field(default=None)
...
@define(kw_only=True)
class V1alpha1LabelSpec:
    key: str = field()
    value: str = field()
    backgroundColor: Optional[str] = field(default=None)
    clusters: Optional[List[str]] = field(default=None)


@define(kw_only=True)
class V1alpha1Label:
    spec: V1alpha1LabelSpec = field()
    apiVersion: Optional[str] = field(
        default=None,
        metadata={
            "description": "APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources"
