...
__ALL__ = [
    ...
    "V1NamespaceStatus",
    "V1Namespace",
    "V1alpha2ClusterOverride",
    "V1alpha2GenericOverrideItem",
    "V1alpha2GenericClusterReference",
...
@define(kw_only=True)
class V1beta1GenericClusterReference:
    name: str = field()


@define(kw_only=True)
class V1beta1GenericPlacement:
    clusterSelector: Optional[V1LabelSelector] = field(default=None)
    clusters: Optional[List[V1beta1GenericClusterReference]] = field(default=None)
...
@define(kw_only=True)
class V1beta1WorkspaceSpec:
    manager: Optional[str] = field(default=None)


@define(kw_only=True)
class V1beta1Template:
    metadata: Optional[V1beta1ObjectMeta] = field(default=None)
    spec: Optional[V1beta1WorkspaceSpec] = field(default=None)


@define(kw_only=True)
class V1beta1WorkspaceTemplateSpec:
    placement: V1beta1GenericPlacement = field()
    template: V1beta1Template = field()


@define(kw_only=True)
class V1beta1WorkspaceTemplate:
    apiVersion: Optional[str] = field(
        default=None,
        metadata={
...
class V1alpha1Workspace:
    ...
    metadata: Optional[V1ObjectMeta] = field(default=None)
    spec: Optional[V1alpha1WorkspaceSpec] = field(default=None)
...
@define(kw_only=True)
class V1alpha2GenericOverrideItem:
    clusterName: str = field()
    clusterOverrides: Optional[List[V1alpha2ClusterOverride]] = field(default=None)


@define(kw_only=True)
class V1alpha2GenericClusterReference:
    name: str = field()


@define(kw_only=True)
class V1alpha2GenericPlacementFields:
    clusterSelector: Optional[V1LabelSelector] = field(default=None)
    clusters: Optional[List[V1alpha2GenericClusterReference]] = field(default=None)


@define(kw_only=True)
class V1alpha2WorkspaceTemplateSpec:
    metadata: Optional[V1ObjectMeta] = field(default=None)
    spec: Optional[V1beta1WorkspaceSpec] = field(default=None)


@define(kw_only=True)
class V1alpha2FederatedWorkspaceSpec:
    placement: V1alpha2GenericPlacementFields = field()
    template: V1alpha2WorkspaceTemplateSpec = field()
    overrides: Optional[List[V1alpha2GenericOverrideItem]] = field(default=None)


@define(kw_only=True)
class V1alpha2WorkspaceTemplate:
    apiVersion: Optional[str] = field(
        default=None,
        metadata={
            "description": "APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources"
    ...
    metadata: Optional[V1ObjectMeta] = field(default=None)
    spec: Optional[V1alpha2FederatedWorkspaceSpec] = field(default=None)
...
class V1ScopedResourceSelectorRequirement:
    ...
    scopeName: str = field(
        metadata={"description": "The name of the scope that the selector applies to."}
    )
    values: Optional[List[str]] = field(
        default=None,
        metadata={
...
class V1ScopeSelector:
    matchExpressions: Optional[List[V1ScopedResourceSelectorRequirement]] = field(
        default=None,
        metadata={
...
class V1ResourceQuotaSpec:
    ...
    scopeSelector: Optional[V1ScopeSelector] = field(
        default=None,
        metadata={
...
@define(kw_only=True)
class V1alpha2ResourceQuotaSpec:
    quota: V1ResourceQuotaSpec = field()
    selector: Dict = field()


@define(kw_only=True)
class V1alpha2ResourceQuotaStatusByNamespace:
    namespace: str = field()
    hard: Optional[Dict] = field(
        default=None,
        metadata={
...
@define(kw_only=True)
class V1alpha2ResourceQuotaStatus:
    namespaces: List[V1alpha2ResourceQuotaStatusByNamespace] = field()
    total: V1ResourceQuotaStatus = field()


@define(kw_only=True)
class V1alpha2ResourceQuota:
