...
__ALL__ = ["HandleClusterMetricsQueryAPI"]


@define(kw_only=True)
@router.get("/kapis/monitoring.kubesphere.io/v1beta1/cluster_metrics")
class HandleClusterMetricsQueryAPI(BaseAPI[MonitoringMetrics]):
    """None"""
    ...
    endpoint_id: Optional[str] = field(default="handleClusterMetricsQuery")
