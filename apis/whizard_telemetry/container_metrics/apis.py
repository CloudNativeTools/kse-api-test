...
__ALL__ = ["HandleContainerMetricsQueryAPI"]


@define(kw_only=True)
@router.get("/kapis/monitoring.kubesphere.io/v1beta1/container_metrics")
class HandleContainerMetricsQueryAPI(BaseAPI[MonitoringMetrics]):
    """None"""
    ...
    class QueryParams:
        ...
        pod_resources_filter: Optional[str] = field(
            default=None,
            metadata={
    ...
    endpoint_id: Optional[str] = field(default="handleContainerMetricsQuery")
