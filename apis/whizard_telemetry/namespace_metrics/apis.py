...
__ALL__ = ["HandleNamespaceMetricsQueryAPI"]


@define(kw_only=True)
@router.get("/kapis/monitoring.kubesphere.io/v1beta1/namespace_metrics")
class HandleNamespaceMetricsQueryAPI(BaseAPI[MonitoringMetrics]):
    """None"""
    ...
    endpoint_id: Optional[str] = field(default="handleNamespaceMetricsQuery")
