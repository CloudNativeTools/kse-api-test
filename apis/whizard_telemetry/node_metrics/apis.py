...
__ALL__ = ["HandleNodeMetricsQueryAPI"]


@define(kw_only=True)
@router.get("/kapis/monitoring.kubesphere.io/v1beta1/node_metrics")
class HandleNodeMetricsQueryAPI(BaseAPI[MonitoringMetrics]):
    """None"""
    ...
    endpoint_id: Optional[str] = field(default="handleNodeMetricsQuery")
