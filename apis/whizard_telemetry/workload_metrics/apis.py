...
__ALL__ = ["HandleWorkloadMetricsQueryAPI"]


@define(kw_only=True)
@router.get("/kapis/monitoring.kubesphere.io/v1beta1/workload_metrics")
class HandleWorkloadMetricsQueryAPI(BaseAPI[MonitoringMetrics]):
    """None"""
    ...
    class QueryParams:
        ...
        workload_kind: Optional[str] = field(
            default=None,
            metadata={
    ...
    endpoint_id: Optional[str] = field(default="handleWorkloadMetricsQuery")
